...
function buildFaqs(p: { basic: string; standard: string; manager: string }) {
  ...
  {
    q: "你们说「7 天售后保障」，怎么退？",
    a: "未开始人工服务前可全额退款；交付后 7 日内、未下载源文件的，可申请退款；已进入人工精修或已交付源文件的，提供免费修改。具体以《服务协议》付款与退款条款为准。",
  },
  {
    q: "生成的 logo 和 IP 公仔，版权归谁？能商用、能注册商标吗？",
    a: "交付文件的使用权与商用许可归您，可自由商用。能否注册商标取决于商标局审查及在先权利，建议定稿后做查重评估，我们可协助对接商标代理。",
  },
  {
    q: "我填的店名、电话、地址，安全吗？",
    a: "只用于制作您的品牌手册，未经您书面同意，不向任何第三方提供。匿名化作品展示会事先征得您同意（详见服务协议）。您想删除，随时联系我们处理。",
  },
  {
    q: "AI 做的会不会很土、和别家撞款？",
    a: "不是套模板。按您店的行业、名字、调性量身生成 + 人工精修，撞款概率低；标准版含 2 次免费修改，品牌管家月费期内不限次，改到满意为止。",
  },
  {
    q: "交付里包含什么？",
  ...
  {
    q: "怎么收费？",
    a: `基础版 ¥${p.basic} / 标准版 ¥${p.standard} / 品牌管家 ¥${p.manager}/月。新手建议先从标准版体验。加急 24 小时交付加收 50%；额外内容 ¥30/条；修改超出免费次数 ¥50/次。`,
  },
  {
