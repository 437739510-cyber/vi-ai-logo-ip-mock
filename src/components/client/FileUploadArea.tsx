  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-neutral-400 text-xs">（选填）</span>
      </div>
      {files.length > 0 && (
          ...
          {files.map((item, i) => (
            <div key={i} className="p-4 bg-neutral-50 border border-neutral-200 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input type="text" placeholder="名称（选填）" value={names[i] || ""} onChange={(e) => onNameChange(i, e.target.value)} className="px-3 py-1.5 text-sm border border-neutral-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
